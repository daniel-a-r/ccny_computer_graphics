...
void main() 
{
	...
	vec2 newVec = vec2(a_Position[0]*cosTheta - a_Position[1]*sinTheta, a_Position[0]*sinTheta + a_Position[1]*cosTheta);
	
	gl_Position = u_Projection * u_Modelview * vec4(newVec, 0, 1);
